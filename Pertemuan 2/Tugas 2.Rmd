...
plot(seq(1,99,1), sisaan, col = "steelblue", pch = 20, xlab = "Sisaan", ylab = "Order", main = "Sisaan vs Order")
lines(seq(1,99,1), sisaan, col = "red")
abline(a = 0, b = 0, lwd = 2)
```
...
#Transformasi Balik
cat("y = ", coef(modelHL)[1]/(1-0.9), coef(modelHL)[2],"x1", "+", coef(modelHL)[3],"x2", sep = "")
```
