...
MA(2) dengan $\theta_1 = 0.4$ dan $\theta_2=0.6$ sebanyak 300 observasi dan $c=0$. Karena diperlukan dua nilai awal untuk $e_{t-1}$ dan $e_{t-2}$, masukkan nilai pertama dan kedua white noise sebagai nilai awal tersebut.
...
AR(2) dengan $\phi_1 = 0.5$ dan $\phi_2=0.2$ sebanyak 300 observasi dan $c=0$.
...
```{r}
set.seed(078)
ar2 <- arima.sim(list(order=c(2,0,0), ar=c(0.5,0.2)), n=300) #c(p,d,q)
ar2
```
...
Korelasi antara $Y_t$ dengan $Y_{t-1}$ dari hasil simulasi mendekati perhitungan teoritis yaitu $\rho_1=\frac{\phi_1}{(1-\phi_2)}=\frac{0.5}{(1-0.2)}=0.63$
...
Korelasi antara $Y_t$ dengan $Y_{t-2}$ dari hasil simulasi mendekati perhitungan teoritis yaitu $\rho_2=\frac{\phi_2(1-\phi_2)+\phi_1^2}{(1-\phi_2)}=\frac{0.2(1-0.2)+0,5^2}{(1-0.2)}=0.51$
...
Korelasi antara $Y_t$ dengan $Y_{t-3}$ dari hasil simulasi mendekati perhitungan teoritis yaitu $\rho_3=\frac{\phi_1\phi_2+\phi_1^3}{(1-\phi_2)}+\phi_1\phi_2=\frac{0.5(0.2)+(0.5)^3}{(1-0.2)}+0.5(0.2)=0.38$
