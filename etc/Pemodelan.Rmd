...
```{r}
#---OVERFITTING---#
model1a.ma2=Arima(train.diff, order=c(1,0,2),method="ML")
summary(model1a.ma2) #327.31
lmtest::coeftest(model1a.ma2) #ar1 tidak signifikan

model1b.ma2=Arima(train.diff, order=c(0,0,3),method="ML")
...
# Validasi Model
harusnya sebelum forecasting
-lakukan forecasting sebanyak data testing
-cek nilai keakuratan
-forecasting
```{r}
...
>>>>>>> ac93003bc0f31d52a265e94dda7ad24407a634ba
